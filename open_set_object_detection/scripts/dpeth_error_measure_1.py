...
def compute_rmse():
    ...
    # Replace pixels with RMSE > 25 with the mean of their neighbors
    mask = rmse_depth > 25
    rmse_depth_filtered = np.copy(rmse_depth)
    rmse_depth_filtered[mask] = generic_filter(rmse_depth, np.nanmean, size=3, mode='nearest')[mask]
    
    return rmse_depth_filtered
